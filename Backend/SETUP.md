...
DEFAULT_FROM_EMAIL=noreply@nepaltrekkingapp.com
...
**Note**: Email settings are required when you want real OTP emails. For local development, `django.core.mail.backends.console.EmailBackend` will print OTPs to the terminal.
